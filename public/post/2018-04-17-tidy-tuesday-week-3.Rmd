...
library(tidyverse)
library(rjson)
colors <- fromJSON(file = "~/Code/tidy_tuesday/tidy_tuesday_week_3/colors.json")
```
...
```{r data_import}
data <- readxl::read_xlsx("~/Code/tidy_tuesday/tidy_tuesday_week_3/global_mortality.xlsx") %>% 
